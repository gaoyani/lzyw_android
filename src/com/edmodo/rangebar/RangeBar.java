...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.slider_block;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.slider_block_down;
    ...
    private boolean isSingleThumb = false;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mBar = new Bar(ctx, marginLeft, yPos, barLength, mTickCount, mTickHeightDP, mBarWeight, mBarColor, mFontSize);
    ...
    /**
     * Set the font size of the range bar.
     * 
     * @param barColor Integer specifying the color of the bar line.
     */
