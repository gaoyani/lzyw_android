...
public class ServiceReservationActivity extends Activity implements
	...
	OnTimeChangedListener onTimeChangeListener = new OnTimeChangedListener() {
		public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
			try {
				...
				if (lastMinute > minute || (lastMinute == 0 && minute == 59)) {
					if (minute > 0 && minute < 15) {
						view.setCurrentMinute(0);
					} else if (minute > 15 && minute < 30) {
						view.setCurrentMinute(15);
					} else if (minute > 30 && minute < 45) {
						view.setCurrentMinute(30);
					} else if (minute > 45 && minute < 60){
						view.setCurrentMinute(45);
					}
				} else {
					if (minute > 0 && minute < 15) {
						view.setCurrentMinute(15);
				...
				lastMinute = view.getCurrentMinute();
