 ...
 * 乐推送列表页
 */
public class RcFileListFragment extends Fragment {
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View view = inflater.inflate(R.layout.activity_push_file_list,
				container, false);
		initUI(view);
		return view;
	}
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			if (dataList.size() > 0 && position >= 0
				...
				case G.FOLDER:
					...
					intent.setClass(context, RcFileListFragment.class);
